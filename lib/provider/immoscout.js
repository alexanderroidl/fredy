/**
 * ImmoScout24 provider using the mobile API to retrieve listings.
 *
 ...
 * it by intercepting traffic from an android emulator running the ImmoScout24 app.
...
async function getListings(url) {
  ...
  if (!response.ok) {
    console.error('Error fetching data from ImmoScout24 Mobile API:', response.statusText);
    return [];
  }
